...
var editColumnEvent = {
    'click .btn-edit': function(e, value, row, index)
    {
        ...
        var route = `/admin/workshop-events/${row.id}`;
        updateid = row.id;
        $.ajax({
            url: route,
            type: 'get',
...
var deleteColumnEvent = {
    'click .btn-delete': function(e, value, row, index) {
        Swal.fire({
            ...
            if (resp.value) {
                $.ajax({
                    url: `/admin/workshop-events/${row.id}`,
                    type: 'delete',
                    dataType: 'json',
                    success: function(result){
                        loadEvents();
...
function saveWorkshop() {
    ...
    if(id) {
        data['id'] = id;
        sendUpsertEventRequest(`/admin/workshop-events/${id}`, 'put', data);
    } else {
        sendUpsertEventRequest('/admin/workshop-events', 'post', data);
    }
}
