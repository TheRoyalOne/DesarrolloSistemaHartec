...
class WorkshopEventsController extends Controller
{
     ...
     */
    public function workshopEvent(Request $request, $id)
    {
        // Validar existencia
        ...
        $workshop = WorkshopEvent::find($id);

        return response()->json([
            'success' => true,
            'message' => 'WORKSHOP_EVENTS_READ',
            'data' => $workshop
        ], 200);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function workshopEvents(Request $request)
    {
        // Recolectar todos los registros y devolver respuesta
        $workshops = WorkshopEvent::orderBy('type', 'asc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $workshop = WorkshopEvent::create($input_data);
        $workshop->save();

        return response()->json([
            'success' => true,
            'message' => 'WORKSHOP_EVENTS_STORE',
            'data' => $workshop
        ], 200);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'WORKSHOP_EVENTS__UPDATE',
            'data' => $workshop
        ], 200);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'WORKSHOP_EVENTS__DELETE',
            'data' => $workshop
        ], 200);
    }
}
