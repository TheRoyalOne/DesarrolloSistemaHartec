...
<div class="panel-heading">
    <h3 class="panel-title">Salida de Árboles</h3>   
</div>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Registrar Salida de Árboles</h5>
      ...
      {{-- <form id="form" action="" enctype="multipart/form-data"> --}}
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('adoption_lbl','Evento de Adopción:') !!}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('labels','Etiquetas:') !!}
                        {!! Form::text('labels',null,['class'=>'form-control','placeholder'=>'Etiquetas']) !!}
                    </div>
                </div>
            </div>
            <hr>
              ...
              <div class="col-md-12">
                <div class="input-group form-group">
                  <div class="input-group-prepend">
                    {!! Form::label('species_lbl','Especies:', ['class'=>'input-group-text']) !!}
                  </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="saveTreeLeaving()" class="btn btn-primary">Guardar</button>
        </div>
      {{-- </form> --}}
    </div>
  </div>
...
@section('js')
<script src="{{asset('js/tree-leavings.js')}}"></script>
<script>
  var getURL = window.location;
  var baseURL = "{{ url()->current() }}";
  var allSpecies = {!! json_encode($allSpecies) !!};
  var nurseries = {!! json_encode($nurseries) !!};
