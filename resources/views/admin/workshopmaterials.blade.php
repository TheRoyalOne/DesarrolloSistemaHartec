...
<div class="panel-heading">
    <h3 class="panel-title">Materiales del Taller</h3>   
</div>

<button type="button" onclick="cleanWorkshopMaterialForm()" class="btn btn-primary" data-toggle="modal" data-target="#addModal" data-whatever="@mdo">Agregar</button>
<table
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <div class="row">
              <div class="col">
                  <div class="form-group">
                      ...
                      {!! Form::text('name',null,['class'=>'form-control','placeholder'=>'Material','required','autofocus']) !!}
                  </div>
              </div>
          </div>
          <div class="row">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="saveWorkshopMaterial()" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
@section('js')
<script src="{{asset('js/workshopmaterials.js')}}"></script>
<script>
